	...
	<section class="content">
       <div class="row">
			...
			<tr role="row" align="center" class="1" id="1_1" >
                         ...
                         <td>
                             <img width="20" height="20" src="${ctx}/Public/images/yes.png" onclick="changeTableVal('goods_category','id','1','is_hot',this)"/>
                         </td>
	                 <td>
                             <img width="20" height="20" src="${ctx}/Public/images/yes.png" onclick="changeTableVal('goods_category','id','1','is_show',this)"/>                             
                         </td>
	                     <td>                                 
					   ...
					   <tr role="row" align="center" class="2" id="2_12" style="display:none">
                         ...
                         <td>
                             <img width="20" height="20" src="${ctx}/Public/images/cancel.png" onclick="changeTableVal('goods_category','id','12','is_hot',this)"/>
                         </td>
	                 <td>
                             <img width="20" height="20" src="${ctx}/Public/images/yes.png" onclick="changeTableVal('goods_category','id','12','is_show',this)"/>                             
                         </td>
	                     <td>                                 
					   ...
					   <tr role="row" align="center" class="3" id="3_100" style="display:none">
                         ...
                         <td>
                             <img width="20" height="20" src="${ctx}/Public/images/cancel.png" onclick="changeTableVal('goods_category','id','100','is_hot',this)"/>
                         </td>
	                 <td>
                             <img width="20" height="20" src="${ctx}/Public/images/yes.png" onclick="changeTableVal('goods_category','id','100','is_show',this)"/>                             
                         </td>
	                     <td>                                 
